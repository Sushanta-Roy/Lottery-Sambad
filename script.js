...
class ImageWebController {
            ...
            for (const time of times) {
                for (const ext of extensions) {
                    ...
                    if (exists) {
                        ...
                        this.imageCache.set(filename, null);
                    }
                }
            }
    ...
    displayImageDirectly(imageInfo) {
        ...
        img.src = imageInfo.originalFilename;
    ...
    async checkImageExists(filename) {
        return new Promise((resolve) => {
            ...
            }, 400); // reduced timeout for static hosting
    ...
    async checkImageExistsFast(filename) {
        return new Promise((resolve) => {
            ...
            }, 300); // 0.3 second timeout for fast loading
    ...
    async checkImageExistsInstant(filename) {
        return new Promise((resolve) => {
            ...
            }, 200); // 0.2 second timeout for instant loading
